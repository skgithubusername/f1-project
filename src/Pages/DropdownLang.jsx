...
// //   const options = ['Hindi', 'English','Urdu','Bengali','Gujarati'];
...
//     setSelectedOption(option);
//     setIsOpen(false);
//     onSelect(option); // Ensure onSelect is called with the selected option
//   };
...
const DropdownLang = ({ onSelect }) => {
  ...
  const handleOptionClick = (option) => {
    ...
    if (typeof onSelect === 'function') {
      onSelect(option); // Ensure onSelect is a function before calling it
    }
  };
